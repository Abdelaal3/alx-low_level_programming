...
/**
 * check_elf - checking whether a file is in the ELF format.
 * @e_ident: to an array holding the ELF magic numbers.
 *
...
/**
 * print_magic - printing the ELF header's magic numbers.
 * @e_ident: A pointer to an array holding the ELF magic number values.
 *
...
/**
 * print_entry - Printingg the entry point of an ELF header.
 ...
 * @argv: A collection of argument pointers.
 *
 * Return: 0 on success.
 *
